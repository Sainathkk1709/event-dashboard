...
const LoginForm: React.FC = () => {
  ...
  const demoAccounts = [
    { type: 'User', email: 'keerthana01@gmail.com', password: 'keerthana01' },
    { type: 'Organizer', email: 'rishwitha29@gmail.com', password: 'rishwitha29' },
    { type: 'Admin', email: 'r.bhavyasri1720@gmail.com', password: 'sb@1720' }
  ];
